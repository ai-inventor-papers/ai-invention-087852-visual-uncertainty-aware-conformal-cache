...
- **1. create_idea** — `hypo_loop`
  - round_1
    - `chat/messages/1_create_idea/round_1/1_gen_hypo.md` — 184 messages
    - `chat/messages/1_create_idea/round_1/2_review_hypo.md` — 181 messages
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `2_gen_plan/` — 3 task(s)
      ...
      - `chat/messages/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_1.md` — 48 messages
      - `chat/messages/2_test_idea/round_1/2_gen_plan/gen_plan_research_1.md` — 33 messages
    - `3_gen_art/` — 3 task(s)
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_dataset_1.md` — 592 messages
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 247 messages
      - `chat/messages/2_test_idea/round_1/3_gen_art/gen_art_research_1.md` — 611 messages
    - `chat/messages/2_test_idea/round_1/4_gen_paper_text.md` — 397 messages
    - `chat/messages/2_test_idea/round_1/5_review_paper.md` — 109 messages
    - `chat/messages/2_test_idea/round_1/6_upd_hypo.md` — 17 messages
  - round_2
    - `chat/messages/2_test_idea/round_2/1_gen_strat.md` — 68 messages
    - `2_gen_plan/` — 2 task(s)
      - `chat/messages/2_test_idea/round_2/2_gen_plan/gen_plan_evaluation_1.md` — 48 messages
      - `chat/messages/2_test_idea/round_2/2_gen_plan/gen_plan_experiment_1.md` — 11 messages
    - `3_gen_art/` — 2 task(s)
      - `chat/messages/2_test_idea/round_2/3_gen_art/gen_art_evaluation_1.md` — 312 messages
      - `chat/messages/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 165 messages
    - `chat/messages/2_test_idea/round_2/4_gen_paper_text.md` — 175 messages
    - `chat/messages/2_test_idea/round_2/5_review_paper.md` — 123 messages
    - `chat/messages/2_test_idea/round_2/6_upd_hypo.md` — 53 messages
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 4 task(s)
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_1.md` — 106 messages
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_2.md` — 144 messages
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_3.md` — 123 messages
    - `chat/messages/3_report_results/1_gen_viz/gen_viz_4.md` — 97 messages
  - `2_gen_demo_art/` — 4 task(s)
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_dataset_1.md` — 169 messages
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_evaluation_1.md` — 358 messages
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_experiment_1.md` — 344 messages
    - `chat/messages/3_report_results/2_gen_demo_art/gen_demo_art_experiment_2.md` — 109 messages
  - `3_gen_full_paper/` — 2 task(s)
    - `chat/messages/3_report_results/3_gen_full_paper/gen_full_paper.md` — 198 messages
    - `chat/messages/3_report_results/3_gen_full_paper/gen_paper_site.md` — 141 messages
